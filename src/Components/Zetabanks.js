import images1 from "../Components/Images/images1.jpeg"
import bank from "../Components/Images/payment-suite.png"
import AOS from "aos";
    ...
    return(
        <div className="w-screen h-[580px] flex"  data-aos="fade-up">
            ...
            <div className="flex flex-col h-[580px] w-6/12 ml-[50px] justify-around">
                ...
                <div className="border rounded-md h-[24px] w-[142px] text-[14px] bg-[#e4e4e4] mb-[20px] font-semibold mt-[20px] text-center ...">For Banks</div>
